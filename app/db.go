...
func InitDB() {
	var err error
	mysqlArgs := Config.DB.User + ":" + Config.DB.Password + "@tcp(" + Config.DB.Host + ":" + Config.DB.Port + ")/" + Config.DB.Name + "?charset=utf8mb4&parseTime=True&loc=Local&multiStatements=true"
